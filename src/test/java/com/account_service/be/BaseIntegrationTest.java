...
public abstract class BaseIntegrationTest {
    ...
    protected AccountModel createTestAccount(String email, String roleName) {
        ...
        jdbcTemplate.execute("INSERT INTO tm_features (feature_id, feature_key, feature_name) VALUES (1, 'catalog', 'Manage Catalog'), (2, 'category', 'Manage Categories'), (3, 'table', 'Manage Tables'), (4, 'voucher', 'Manage Vouchers'), (5, 'promotion', 'Manage Promotions'), (6, 'barista', 'Manage Baristas'), (7, 'order', 'Incoming Orders'), (8, 'inventory', 'Inventory Status'), (9, 'report', 'Analytics Overview'), (10, 'role_management', 'Role Management') ON CONFLICT (feature_id) DO NOTHING");
        jdbcTemplate.execute("INSERT INTO tm_role_features (role_id, feature_id, can_view, can_create, can_edit, can_delete) VALUES (1, 1, true, true, true, true), (1, 2, true, true, true, true), (1, 3, true, true, true, true), (1, 4, true, true, true, true), (1, 5, true, true, true, true), (1, 6, true, true, true, true), (1, 7, true, true, true, true), (1, 8, true, true, true, true), (1, 9, true, true, true, true), (1, 10, true, true, true, true), (3, 6, true, true, true, true) ON CONFLICT (role_id, feature_id) DO NOTHING");
